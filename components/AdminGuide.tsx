...
const AdminGuide: React.FC<AdminGuideProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-green-950/90 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div className="bg-white rounded-[2.5rem] w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
        <div className="p-8 border-b bg-green-800 text-white flex justify-between items-center shrink-0">
          <div>
            ...
            <p className="text-green-100 text-xs font-bold uppercase tracking-widest mt-1">Sistem Ujian Berbasis Komputer E-Pro CBT Pro 1.2</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 lg:p-12 space-y-10 custom-scrollbar">
          <div className="bg-green-50 p-6 rounded-[2rem] border border-green-100 italic">
          ...
          <section className="flex gap-6">
            <div className="w-12 h-12 bg-green-100 text-green-800 rounded-2xl flex items-center justify-center font-black text-xl shrink-0 shadow-sm">1</div>
            <div>
              <h3 className="text-xl font-black text-slate-800 mb-2">Memahami "TOKEN" Ujian</h3>
              <p className="text-slate-500 text-sm leading-relaxed font-medium">
                Satu <b>Token</b> adalah satu paket soal. Contoh: Token <span className="text-green-800 font-bold">UJIAN_01</span>. 
          ...
          {/* STEP 3 */}
          <section className="flex gap-6">
            <div className="w-12 h-12 bg-green-100 text-green-800 rounded-2xl flex items-center justify-center font-black text-xl shrink-0 shadow-sm">3</div>
            <div>
              ...
              <div className="bg-green-50 border border-green-100 p-4 rounded-2xl">
                <ol className="text-xs text-green-800 space-y-2 font-bold">
                  <li>1. Klik <b>"Generate Soal Otomatis ✨"</b> di sidebar.</li>
                  <li>2. Masukkan topik atau upload file materi acuan.</li>
                  <li>3. Klik <b>"IMPORT KE BANK SOAL"</b> untuk memasukkan soal langsung.</li>
                  <li>4. Jangan lupa klik <b>"KIRIM KE CLOUD"</b> agar soal bisa diakses siswa.</li>
                </ol>
              </div>
            </div>
          </section>
          ...
          {/* STEP 4 */}
          <section className="flex gap-6">
            <div className="w-12 h-12 bg-green-100 text-green-800 rounded-2xl flex items-center justify-center font-black text-xl shrink-0 shadow-sm">4</div>
            <div>
              <h3 className="text-xl font-black text-slate-800 mb-2">SINKRONISASI CLOUD (PENTING!)</h3>
              <div className="p-5 bg-green-950 text-white rounded-[2rem] shadow-xl">
        ...
        <div className="p-8 border-t bg-slate-50 shrink-0 flex justify-center">
          <button onClick={onClose} className="px-12 py-4 bg-green-800 text-white font-black rounded-2xl shadow-xl hover:bg-green-900 transition-all uppercase tracking-widest text-xs">MULAI KELOLA UJIAN</button>
        </div>
      </div>
    </div>
  );
