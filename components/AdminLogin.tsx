    ...
    <div className="min-h-screen bg-green-50 flex items-center justify-center p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-slate-200">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-green-800 rounded-full flex items-center justify-center mx-auto mb-4 text-white shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input 
              ...
              className={`w-full px-4 py-4 bg-green-50 border-2 rounded-2xl outline-none transition-all font-bold ${error ? 'border-red-500 bg-red-50' : 'border-slate-100 focus:border-green-800'}`}
              placeholder="••••••••"
              autoFocus
            />
            {error && (
          ...
          <button 
            type="submit"
            className="w-full bg-green-950 hover:bg-black text-white font-black py-4 rounded-2xl transition-all shadow-xl shadow-slate-200 uppercase tracking-widest text-xs"
          >
            MASUK PANEL ADMIN
          </button>
        </form>
        ...
        <div className="mt-6 pt-6 border-t border-slate-100 text-center">
          ...
          <a 
            ...
            className="text-green-800 font-black text-[10px] uppercase hover:underline"
          >
